...
<div class="bg-white rounded-lg shadow-lg overflow-hidden">
    <div class="p-6">
        <h2 class="text-3xl font-bold text-[#1F3A5F] font-display mb-8">Create New Package</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4" required
                              class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#FFA733] focus:ring-[#FFA733]">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <input type="file" name="image" id="image" required accept="image/*"
                           class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4
                                  ...
                                  cursor-pointer">
                    <p class="mt-1 text-sm text-gray-500">Upload a high-quality image of the destination</p>
                    @error('image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
